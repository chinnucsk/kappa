        ...
        [
            ...
            {"error invalid_apply",
                ?_assertError({invalid_apply, {dummy, function4, 1},
                               {invalid_apply, {dummy, function1, 1}, badarith}},
                              only(spam, [a]))},

            {"error invalid_apply",
                ?_assertError({invalid_apply, {dummy, function4, 1}, undef},
                              only(spam, [10, 20]))},
            {"stop",
                ?_assertEqual(ok,
                              stop())}
        ...
        [
            ...
            {"",
                ?_assertEqual([40,20,30],
                              all(spam, [10]))},
            {"error invalid_apply",
                ?_assertError({invalid_apply, {dummy, function4, 1}, badarith},
                              all(spam, [a]))},
        ...
        [
            ...
            {"",
                ?_assertEqual(90,
                              every(spam, 0, [10]))},
            {"error invalid_apply",
                ?_assertError({invalid_apply, {dummy, function1, 2}, badarith},
                              every(spam, 0, [a]))},

            {"error invalid_apply",
                ?_assertError({invalid_apply, {dummy, function1, 2}, undef},
                              every(spam, 0, [10, 20]))},
            {"stop",
                ?_assertEqual(ok,
                              stop())}
